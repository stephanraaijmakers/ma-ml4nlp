...
def process_data_simpsons(fn_speakers, fn_utterances, fn_conversations):
    ...
    for utterance in tqdm(utterance_data):
        ...
        try:
            line_id, speaker, text = utterance_info[0], utterance_info[1], utterance_info[2]
        except:
...
if __name__=="__main__":
    process_data_simpsons(sys.argv[1], sys.argv[2],sys.argv[3])
